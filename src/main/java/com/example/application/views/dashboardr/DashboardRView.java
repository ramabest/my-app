package com.example.application.views.dashboardr;


import com.example.application.views.MainLayout;
import com.example.application.views.dashboardr.ServiceHealth.Status;
...
@PageTitle("Dashboard(R)")
@Route(value = "dashboard", layout = MainLayout.class)
@AnonymousAllowed
public class DashboardRView extends Main {

    public DashboardRView() {
        addClassName("dashboard-r-view");
